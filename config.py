...
# Network settings - tuned for PythonAnywhere (higher latency outbound proxy)
NETWORK_CONFIG = {
    "default_timeout": 60,       # Default timeout for API/RSS requests (was 30s)
    "extended_timeout": 180,     # Extended timeout for slow feeds/PDFs (was 120s)
    "retry_attempts": 5,         # Number of retry attempts
    "base_delay": 8,             # Base delay for exponential backoff (was 5s)
    "min_request_interval": 1.0, # Min time between requests to same domain (was 0.5s)
    "pool_connections": 2,       # Connection pool size
    "pool_maxsize": 3,           # Max pool size
    "mistral_timeout": 90,       # Mistral API timeout (was 60s)
}
...
RSS_FEEDS = [
   ...
   # "https://www.generali.com/.rest/rss/v1/feed?name=pressReleases",
    ...
    "https://www.theage.com.au/rss/environment.xml",
    "https://www.theage.com.au/rss/technology.xml",
    "https://www.theage.com.au/rss/world.xml",
    "https://bsky.app/profile/did:plc:rvuee746th6j5qacfrfc7jed/rss",
    "https://www.frenchdispatch.eu/feed",
    "https://pascallth.substack.com/feed",
    "https://carbonrisk.substack.com/feed",
    "https://davekeating.substack.com/feed",
    "https://www.resilience.org/rss-2/",
